...
@section('title')
    {{trans('utilities.log.page_title')}} | @parent
@stop
...
@section('page-title')
    @pageHeader('utilities.log.page_title','utilities.log.description', 'utilities.log.icon')
@stop
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-sm-9 col-md-10">
                    @if($logs === null)
                        <div>
                            {{trans('utilities.log.file_over_50')}}
                        </div>
                    @else
                        <table id="table-log" class="table table-striped">
                            <thead>
                            <tr>
                                <th>{{trans('utilities.log.level')}}</th>
                                <th>{{trans('utilities.log.date')}}</th>
                                <th>{{trans('utilities.log.content')}}</th>
                            </tr>
                            </thead>
                        </table>
                    @endif
...
<script>
    $(document).ready(function () {
        ...
        $('#delete-log').click(function () {
            return confirm("{{trans('utilities.log.delete_confirm')}}");
        });
    });
</script>
@endpush